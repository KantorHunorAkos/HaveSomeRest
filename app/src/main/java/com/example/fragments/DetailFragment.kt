...
import com.example.havesomerest.MapsActivity
import com.example.havesomerest.databinding.FragmentDetailBinding
import com.example.models.RestaurantPicture
import com.example.models.RestaurantWithPicture
...
class DetailFragment : Fragment(), ImageAdapter.OnItemClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        myDatabaseViewModel.restaurants.observe(requireActivity(), Observer { _ ->
    ...
    //starting an activity to get a picture
