...
import com.example.havesomerest.databinding.FragmentSplashScreenBinding
...
class SplashScreenFragment : Fragment() {
    ...
    private fun preLoadData() {
        ...
        myDatabaseViewModel.useDatabase.observe(
            ...
            androidx.lifecycle.Observer { useDatabase ->
                if (useDatabase == true) {
                    ...
                    myDatabaseViewModel.loadRestaurantsFromDatabase("Addison", 1)
        ...
        myDatabaseViewModel.getCount("Addison")
    }
